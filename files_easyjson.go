...
func easyjson3f98fba7DecodeGithubComBm0IcqBotApi(in *jlexer.Lexer, out *FileInfoResponse) {
...
func easyjson3f98fba7EncodeGithubComBm0IcqBotApi(out *jwriter.Writer, in FileInfoResponse) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v FileInfoResponse) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson3f98fba7EncodeGithubComBm0IcqBotApi(&w, v)
...
func (v *FileInfoResponse) UnmarshalJSON(data []byte) error {
	...
	easyjson3f98fba7DecodeGithubComBm0IcqBotApi(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *FileInfoResponse) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson3f98fba7DecodeGithubComBm0IcqBotApi(l, v)
}
